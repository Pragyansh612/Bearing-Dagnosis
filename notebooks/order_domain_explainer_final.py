...
out_path = os.path.join(RESULTS_DIR, 'order_domain_explainer_final.md')
with open(out_path, 'w') as f:
    f.write(explainer)
print(f"Saved to {out_path}")
print("\n--- QUICK REFERENCE (2-minute verbal explanation) ---")
print("""
ORDER TRACKING in 60 seconds:

  Problem:  Fault at 1200 RPM = 87 Hz. Same fault at 1800 RPM = 131 Hz.
            Standard model trained at 1200 RPM misses it at 1800 RPM.

  Solution: Convert Hz → orders (multiples of shaft frequency).
            Outer race fault ALWAYS at 5.43× shaft frequency.
            RPM doesn't matter anymore.

  Result:   Our frequency branch sees the same fault signature
            regardless of which machine or speed it came from.
            This is why we generalize to unseen machines.
""")
